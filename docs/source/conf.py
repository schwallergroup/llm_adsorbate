...
project = "llm_adsorbate"
copyright = f"{date.today().year}, XuanVuNguyen"
author = "XuanVuNguyen"
...
modindex_common_prefix = ["llm_adsorbate."]
...
htmlhelp_basename = "llm_adsorbate_doc"
