...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`schwallergroup/llm_adsorbate`](https://github.com/schwallergroup/llm_adsorbate)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/llm_adsorbate.git`
...
```shell
$ git remote add schwallergroup https://github.com/schwallergroup/llm_adsorbate.git
```
